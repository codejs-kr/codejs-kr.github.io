export default [
  {
    ...
    list: [
      ...
      },
      {
        ...
        date: '2010.08 ~ 2014.09',
        description:
          '개인 사용자들을 위한 PC원격제어 서비스인 리모트뷰는 제가 담당할 당시 이전 버전 서비스를 완전히 리뉴얼하는 프로젝트였으며, 저의 프론트앤드 개발의 씨앗이 되어준 의미 있는 프로젝트입니다.',
        link: '/#/development/remoteview-personal',
        techStack: ['HTML5', 'CSS3', 'ES5', 'jQuery', 'jQuery mobile', 'flot.js'],
      },
      {
        name: '알서포트닷컴 다국어 리뉴얼',
        role: '웹 프론트엔드 개발',
        ...
        description:
          '회사 공식 사이트 개발 프로젝트입니다. 5개 국어를 지원하는 사이트로 다국어 처리를 고려하여 UI 요소들을 확장 가능하도록 마크업 하였습니다.',
