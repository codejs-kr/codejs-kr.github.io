  ...
  return (
    <DevelopmentDetailTemplate title={`${name} (사내문화정착 프로젝트)️`}>
      ...
      <section className="overview">
        <p>
          칭찬합시다는 직접 기획한 프로젝트입니다. 제가 근무하는 회사의 인원이 증가하고 프로젝트 단위로 인원이 나뉘다 보니
        ...
        <p>
          ...
          서비스 특징으로 한 달간 자신에게 전달된 메시지는 다음 달 1일에 공개하도록 했으며,
          바로 확인할 수 있는 메신저가 아닌 편지를 받는 듯한 느낌을 주고자 했습니다.
        </p>
        <p>
