    ...
    <DevelopmentDetailTemplate title={`${name}`}>
      ...
      <section className="overview">
        <p>
          ...
          WOL 기능을 지원하는 하드웨어에 작은 Goahead 웹서버가 구성되었고
          그 내부에서 하드웨어 동작을 제어 & 관리하는 싱글 페이지 어플리케이션을 개발하였습니다.
        </p>
        <p>
          다수의 PC를 제어하는 환경에서 사용되는 서비스로
          RemoteView라는 원격 제어 서비스와 연동해서 전원 제어까지 가능한 하드웨어 기반 서비스입니다.
        </p>
        <p>
          이 프로젝트는 1MB이하로 모든 웹 리소스가 구성되어야 했기 때문에
          UI 모듈은 모두 자체적으로 개발하였으며, <br />
      ...
      <section className="list-wrap">
        <ul>
          ...
          <li>
            <strong>역할</strong>
            <p>서비스 기능 및 UI 개발, 하드웨어간 Interface 설계 및 개발</p>
          </li>
          <li>
