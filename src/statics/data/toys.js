export default [
  ...
  },
  {
    ...
    role: '웹 어플리케이션 설계 및 개발',
    date: '2017',
    description: '음성 인식 API를 개발에 활용하기 위해 다양하게 테스트하며 정리한 예제를 공개합니다.',
  ...
  },
  {
    ...
    date: '2017',
    description:
      'React와 Firebase에 관심을 갖던 시기에 두가지를 활용해서 무언가를 만들어 보고 싶었습니다. 그래서 평소에 자주 사용하는 Evernote를 구현해 보기로 하고 조금씩 작업을 시작해 보았습니다.',
  ...
  },
  {
    ...
    role: '웹 프론트엔드 개발',
    date: '2013',
    description: 'CSS3 Transform 속성을 활용하여 만든 멋진 UI를 보고 한눈에 반해서 코드 분석 후 따라 만들어 봤습니다.',
